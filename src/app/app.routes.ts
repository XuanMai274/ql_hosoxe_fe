...
import { BaoLanhHieuLucComponent } from './page/customer/bao-lanh-hieu-luc/bao-lanh-hieu-luc.component';
...
export const routes: Routes = [
    ...
    // ===== CUSTOMER ROUTES =====
    {
        ...
        children: [
            ...
            {
                path: 'bao-lanh-hieu-luc',
                component: BaoLanhHieuLucComponent,
                canActivate: [RoleGuard],
                data: { roles: ['customer'] }
            }
        ]
